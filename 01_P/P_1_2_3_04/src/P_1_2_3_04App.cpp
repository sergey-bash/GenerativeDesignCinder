...
class P_1_2_3_04App : public AppNative {
public:
	void setup();
...
void P_1_2_3_04App::generateColors()
{
    mColors.clear();
...
void P_1_2_3_04App::update()
{
    mRand.seed(mSeed);
    generateColors();
}

void P_1_2_3_04App::draw()
{
...
void P_1_2_3_04App::mouseDown( MouseEvent event )
{
    
}

void P_1_2_3_04App::mouseMove( MouseEvent event )
{
    mMousePos = event.getPos();
}

void P_1_2_3_04App::mouseUp( MouseEvent event )
{
    mSeed = mRand.nextUint(100000);
}

void P_1_2_3_04App::keyUp(KeyEvent event)
{
    
}

CINDER_APP_NATIVE( P_1_2_3_04App, RendererGl )
